      ...
      <div className="w-1/2 h-full flex flex-col border-r border-gray-850">
        ...
        <div className="h-24 border-t border-gray-800 bg-[#030303] flex flex-col z-20">
            <div className="px-4 py-1 border-b border-gray-800/50 flex justify-between bg-[#080808]">
                <span className="text-[8px] text-gray-600 uppercase font-bold tracking-widest font-mono">Терминал Операций</span>
            </div>
      ...
      <div className="w-1/2 h-full bg-[#111] flex flex-col relative overflow-hidden">
        ...
        <div className="absolute bottom-6 left-6 z-40 bg-[#0d0d0d]/90 backdrop-blur-xl border border-gray-800 p-2 rounded-xl flex flex-col gap-2 shadow-2xl pointer-events-auto border-t-white/5 font-mono">
          <div className="flex bg-black border border-gray-800 rounded-lg overflow-hidden p-0.5 shadow-inner">
            <button onClick={() => setViewMode('mobile')} className={`flex-grow px-3 py-1 text-[8px] font-bold uppercase transition-all ${viewMode === 'mobile' ? 'bg-emerald-900/60 text-emerald-400' : 'text-gray-600 hover:text-gray-400'}`}>Mob</button>
            <button onClick={() => setViewMode('desktop')} className={`flex-grow px-3 py-1 text-[8px] font-bold uppercase border-l border-gray-800 transition-all ${viewMode === 'desktop' ? 'bg-emerald-900/60 text-emerald-400' : 'text-gray-600 hover:text-gray-400'}`}>PC</button>
          </div>
          <div className="flex bg-black border border-gray-800 rounded-lg overflow-hidden p-0.5 shadow-inner">
          ...
          <div className="flex items-center justify-between px-2 bg-black rounded-xl border border-gray-800 h-8 shadow-inner">
            ...
            <span className="text-[9px] font-mono text-gray-400 min-w-[30px] text-center font-bold">{Math.round(zoom*100)}%</span>
